/*
  ...
  - You are about to drop the column `currentPriceUsd` on the `Coin` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "Coin" DROP COLUMN "currentPriceUsd";
