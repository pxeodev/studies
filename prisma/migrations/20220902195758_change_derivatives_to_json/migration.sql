/*
  ...
  - The `derivatives` column on the `Coin` table would be dropped and recreated. This will lead to data loss if there is data in the column.
...
-- AlterTable
ALTER TABLE "Coin" DROP COLUMN "derivatives",
