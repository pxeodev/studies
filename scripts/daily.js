...
const unrankedCoins = ['ftx-token', 'rats', 'bitdao', 'astropepex', 'binaryx-2', 'presearch', 'quadency', 'iq50', 'maga-pepe-2', 'babytrump', 'kamala-horris', 'bitcoin-cats', 'the-resistance-cat', 'povel-durev', 'american-coin']
